%**************************************************************************
%   Name: yeh_ini2struct_utf8.m v20240813a
%   Copyright:  
%   Author: HsiupoYeh 
%   Version: v20240813a
%   Description: 讀取INI檔案的函數，INI檔案編碼需為UTF-8。
%   呼叫方法: 
%       IniFile = yeh_ini2struct_utf8('Config.ini');
%**************************************************************************
function IniFile = yeh_ini2struct_utf8(input_ini_file_name)
    %----------------------------------------------------------------------
    IniFile.Struct=[];
